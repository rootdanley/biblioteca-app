...
public class App 
{
    public static void main( String[] args ) {
        ...
        Livro livro1 = new LivroFisico("Java", "2023","Katie Sierra", "Fisico",2);
        Livro livro2 = new LivroFisico("E", "2020", "Karen", "Fisico", 3);
        ...
        Livro livro6 = new LivroDigital("Algoritimos e Programação 1","2017","Ivo Mario Martins","Digital","PDF",3645.4,"https://educapes.capes.gov.br/bitstream/capes/176223/2/Algoritmos%20e%20Programa%C3%A7%C3%A3o%20I%20EBOOK.pdf");
        ...
        try {
            ...
            do {
                ...
                if(nivelAcesso == 1 || nivelAcesso == 2){
                    ...
                    System.out.println("O que deseja realizar? (1) Pegar Livro | (2) Devolver Livro | (3) Baixar Livro");
                    opcao = sc.nextInt();
                    sc.nextLine();
                    switch (opcao){
                        case 1:
                                ...
                                user.pegarLivro(biblioteca.teste(titulo));
